 ...
 *
 */
public class ServiceLabelProvider extends StyledCellLabelProvider implements ILabelProvider, IColorProvider {
...
//		imageRegistry.put(new Integer(Component.STATE_ACTIVATING).toString(), ImageDescriptor.createFromURL(DSUIActivator.getDefault().getBundle().getEntry("res/component.png")));
  ...
  public Image getImage(Object obj) {
    if (obj instanceof ServiceReferenceDTO) {
      ServiceReferenceDTO componentConfigurationDTO = (ServiceReferenceDTO) obj;
  ...
  public String getText(Object element) {
    if (element instanceof ServiceReferenceDTO) {
      ServiceReferenceDTO serviceReferenceDTO = (ServiceReferenceDTO) element;
	        StringBuffer buf = new StringBuffer();
      buf.append("[");
      buf.append(serviceReferenceDTO.id);
      buf.append("] ");
      //      for (Entry<String, Object> entry : serviceReferenceDTO.properties.entrySet()) {

      //        buf.append("]");

        //            buf.serviceReferenceDTO
      //      }
